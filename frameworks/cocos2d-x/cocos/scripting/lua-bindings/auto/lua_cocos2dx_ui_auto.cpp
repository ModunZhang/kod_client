...
static int lua_cocos2dx_ui_EditBox_setEnable(lua_State* tolua_S)
{
    int argc = 0;
    cocos2d::ui::EditBox* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_cocos2dx_ui_EditBox_setEnable'", nullptr);
        return 0;
    }
#endif
    ...
    {
        bool arg0;
        ok &= luaval_to_boolean(tolua_S, 2,(bool *)&arg0, "ccui.EditBox:setEnable");
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_ui_EditBox_setEnable'", nullptr);
            return 0;
        }
        cobj->setEnable(arg0);
        lua_settop(tolua_S, 1);
    ...
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "ccui.EditBox:setEnable",argc, 1);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_ui_EditBox_setEnable'.",&tolua_err);
#endif
    return 0;
}
...
int lua_cocos2dx_ui_UITextView_setPlaceholderFontColor(lua_State* tolua_S)
{
    ...
    if (argc == 1) 
    {
        ...
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_ui_UITextView_setPlaceholderFontColor'", nullptr);
            return 0;
        }
        cobj->setPlaceholderFontColor(arg0);
        lua_settop(tolua_S, 1);
...
int lua_cocos2dx_ui_UITextView_setFontColor(lua_State* tolua_S)
{
    ...
    if (argc == 1) 
    {
        ...
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_ui_UITextView_setFontColor'", nullptr);
            return 0;
        }
        cobj->setFontColor(arg0);
        lua_settop(tolua_S, 1);
