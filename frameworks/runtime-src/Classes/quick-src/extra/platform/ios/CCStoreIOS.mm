...
//dannyhe
- (void)purchaseWithIdentifier:(NSString *)productIdentifier count:(int) number
{
    CCLOG("[CCStore_obj] purchaseWithIdentifier() pid: %s count:%d", utf8cstr(productIdentifier),number);
    if (number > 1)
    {
