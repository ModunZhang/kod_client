...
/* method: updateTransactionStates of class  Store */
#ifndef TOLUA_DISABLE_tolua_cocos2dx_extra_ios_iap_luabinding_Store_updateTransactionStates00
static int tolua_cocos2dx_extra_ios_iap_luabinding_Store_updateTransactionStates00(lua_State* tolua_S)
{
#if COCOS2D_DEBUG >= 1
 tolua_Error tolua_err;
 if (
...
#endif
 {
  Store* self = (Store*)  tolua_tousertype(tolua_S,1,0);
#if COCOS2D_DEBUG >= 1
  if (!self) tolua_error(tolua_S,"invalid 'self' in function 'updateTransactionStates'", NULL);
#endif
  {
   self->updateTransactionStates();
  }
 }
 return 0;
#if COCOS2D_DEBUG >= 1
 tolua_lerror:
 tolua_error(tolua_S,"#ferror in function 'updateTransactionStates'.",&tolua_err);
 return 0;
#endif
}
#endif //#ifndef TOLUA_DISABLE

/* method: purchaseWithIdentifier of class  Store */
#ifndef TOLUA_DISABLE_tolua_cocos2dx_extra_ios_iap_luabinding_Store_purchaseWithIdentifier00
static int tolua_cocos2dx_extra_ios_iap_luabinding_Store_purchaseWithIdentifier00(lua_State* tolua_S)
{
#if COCOS2D_DEBUG >= 1
 tolua_Error tolua_err;
 if (
...
#if COCOS2D_DEBUG >= 1
  if (!self) tolua_error(tolua_S,"invalid 'self' in function 'purchaseWithIdentifier'", NULL);
#endif
  {
   bool tolua_ret = (bool)  self->purchaseWithIdentifier(productId,count);
   tolua_pushboolean(tolua_S,(bool)tolua_ret);
  }
 }
 return 1;
#if COCOS2D_DEBUG >= 1
 tolua_lerror:
 tolua_error(tolua_S,"#ferror in function 'purchaseWithIdentifier'.",&tolua_err);
 return 0;
#endif
}
#endif //#ifndef TOLUA_DISABLE
...
TOLUA_API int tolua_cocos2dx_extra_ios_iap_luabinding_open (lua_State* tolua_S)
{
 ...
 tolua_beginmodule(tolua_S,"cc");
  ...
  tolua_beginmodule(tolua_S,"Store");
   ...
   tolua_function(tolua_S,"updateTransactionStates",tolua_cocos2dx_extra_ios_iap_luabinding_Store_updateTransactionStates00);
   tolua_function(tolua_S,"purchaseWithIdentifier",tolua_cocos2dx_extra_ios_iap_luabinding_Store_purchaseWithIdentifier00);
