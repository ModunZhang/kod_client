return {	{ type = "reward"  	    , is_record = true         },
			...
			{ type = "recruit"		, name = "swordsman"		, min = 1  , is_record = true },
			...
			{ type = "recruit"		, name = "sentinel"	    	, min = 1  , is_record = true },
			{ type = "explore"		, is_record = true         },
			...
			{ type = "recruit"		, name = "ranger"	    	, min = 1  , is_record = true },
			...
			{ type = "recruit"		, name = "crossbowman"		, min = 1  , is_record = true },
			...
			{ type = "recruit"		, name = "lancer"	    	, min = 1  , is_record = true },
			...
			{ type = "recruit"		, name = "horseArcher"		, min = 1  , is_record = true },
			...
			{ type = "recruit"		, name = "catapult"	    	, min = 1  , is_record = true },
			...
			{ type = "recruit"		, name = "ballista"	    	, min = 1  , is_record = true },
