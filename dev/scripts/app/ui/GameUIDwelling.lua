...
function GameUIDwelling:CreateCitizenPanel()
    ...
    citizen_layer.citizen_ui[dwelling.CITIZEN_TYPE.CITIZEN] = cc.ui.UIImage.new("dwelling/green_line.png"):addTo(citizen_num_bg)
    citizen_layer.citizen_ui[dwelling.CITIZEN_TYPE.FOOD] = cc.ui.UIImage.new("dwelling/yellow_line.png"):addTo(citizen_num_bg)
    citizen_layer.citizen_ui[dwelling.CITIZEN_TYPE.WOOD] = cc.ui.UIImage.new("dwelling/brown_line.png"):addTo(citizen_num_bg)
    citizen_layer.citizen_ui[dwelling.CITIZEN_TYPE.IRON] = cc.ui.UIImage.new("dwelling/blue_line.png"):addTo(citizen_num_bg)
    citizen_layer.citizen_ui[dwelling.CITIZEN_TYPE.STONE] = cc.ui.UIImage.new("dwelling/grey_line.png"):addTo(citizen_num_bg)
    ...
    for i, v in pairs(citizen_layer.citizen_ui) do
        ...
        if i == dwelling.CITIZEN_TYPE.CITIZEN then
            local head = cc.ui.UIImage.new("dwelling/green_head.png"):addTo(res_info_bg):pos(0, 2)
            ...
            cc.ui.UIImage.new("home/res_citizen.png"):addTo(res_bg):scale(0.8):align(display.CENTER, res_bg_pos.x, res_bg_pos.y)
        ...
        elseif i == dwelling.CITIZEN_TYPE.FOOD then
            local head = cc.ui.UIImage.new("dwelling/yellow_head.png"):addTo(res_info_bg):pos(0, 2)
            local res_bg = cc.ui.UIImage.new("dwelling/res_bg.png"):addTo(head):align(display.CENTER, 20, 40)
            local res_bg_pos = res_bg:getAnchorPointInPoints()
            cc.ui.UIImage.new("home/res_food.png"):addTo(res_bg):scale(0.25):align(display.CENTER, res_bg_pos.x, res_bg_pos.y)
        elseif i == dwelling.CITIZEN_TYPE.WOOD then
            local head = cc.ui.UIImage.new("dwelling/brown_head.png"):addTo(res_info_bg):pos(0, 2)
            local res_bg = cc.ui.UIImage.new("dwelling/res_bg.png"):addTo(head):align(display.CENTER, 20, 40)
            local res_bg_pos = res_bg:getAnchorPointInPoints()
            cc.ui.UIImage.new("home/res_wood.png"):addTo(res_bg):scale(0.25):pos(5, 5):align(display.CENTER, res_bg_pos.x, res_bg_pos.y)
        elseif i == dwelling.CITIZEN_TYPE.IRON then
            local head = cc.ui.UIImage.new("dwelling/blue_head.png"):addTo(res_info_bg):pos(0, 2)
            local res_bg = cc.ui.UIImage.new("dwelling/res_bg.png"):addTo(head):align(display.CENTER, 20, 40)
            local res_bg_pos = res_bg:getAnchorPointInPoints()
            cc.ui.UIImage.new("home/res_iron.png"):addTo(res_bg):scale(0.25):pos(5, 5):align(display.CENTER, res_bg_pos.x, res_bg_pos.y)
        elseif i == dwelling.CITIZEN_TYPE.STONE then
            local head = cc.ui.UIImage.new("dwelling/grey_head.png"):addTo(res_info_bg):pos(0, 2)
            local res_bg = cc.ui.UIImage.new("dwelling/res_bg.png"):addTo(head):align(display.CENTER, 20, 40)
            local res_bg_pos = res_bg:getAnchorPointInPoints()
            cc.ui.UIImage.new("home/res_coin.png"):addTo(res_bg):scale(0.25):pos(5, 5):align(display.CENTER, res_bg_pos.x, res_bg_pos.y)
        end
    ...
    function citizen_layer:UpdateData()
        ...
        citizen_array[dwelling.CITIZEN_TYPE.CITIZEN] = resource_manager:GetPopulationResource():GetNoneAllocatedByTime(app.timer:GetServerTime())
        citizen_array[dwelling.CITIZEN_TYPE.FOOD] = city:GetCitizenByType("farmer")
        citizen_array[dwelling.CITIZEN_TYPE.WOOD] = city:GetCitizenByType("woodcutter")
        citizen_array[dwelling.CITIZEN_TYPE.IRON] = city:GetCitizenByType("miner")
        citizen_array[dwelling.CITIZEN_TYPE.STONE] = city:GetCitizenByType("quarrier")
