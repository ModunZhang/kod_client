...
function LogoScene:onEnter()
    ...
    self.sprite = display.newSprite("batcat_logo_491x677.png", display.cx, display.cy):addTo(self.layer)
...
function LogoScene:onExit()
    cc.Director:getInstance():getTextureCache():removeTextureForKey("batcat_logo_491x677.png")
end
