local AutoUpdateScene = class("AutoUpdateScene", function()
    return display.newScene("AutoUpdateScene")
end)

function AutoUpdateScene:ctor()
...
function AutoUpdateScene:onEnter()
    self:showVersion()
    self:loadLocalJson()
    self:loadServerJson()
end

function AutoUpdateScene:onExit()
end

function AutoUpdateScene:showText(text)
    self:removeText()
...
function AutoUpdateScene:removeText()
...
function AutoUpdateScene:loadLocalJson()
...
function AutoUpdateScene:loadServerJson()
...
function AutoUpdateScene:getUpdateFileList()
    self.m_totalSize = 0
    self.m_currentSize = 0
...
function AutoUpdateScene:downloadFiles(files)
    if #files > 0 then
        local file = files[1]
...
function AutoUpdateScene:saveServerJson()
...
function AutoUpdateScene:showVersion()
