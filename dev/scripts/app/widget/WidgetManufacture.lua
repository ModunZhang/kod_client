...
function WidgetManufacture:Manufacture()
    ...
    item:GetNeedBox():SetClicked(function()
        NetManager:getMakeBuildingMaterialPromise():catch(function(err)
            dump(err:reason())
        end)
    end)
    item:GetMaterial():SetClicked(function()
        NetManager:getFetchMaterialsPromise(self.toolShop:GetBuildingEvent():Id()):catch(function(err)
            dump(err:reason())
        end)
    end)
    ...
    self.list_view:addItem(item)
    item:GetNeedBox():SetClicked(function()
        NetManager:getMakeTechnologyMaterialPromise():catch(function(err)
            dump(err:reason())
        end)
    end)
    item:GetMaterial():SetClicked(function()
        NetManager:getFetchMaterialsPromise(self.toolShop:GetTechnologyEvent():Id()):catch(function(err)
            dump(err:reason())
        end)
    end)
    item:SetStoreMaterials(materials)
