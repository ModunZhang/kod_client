...
function WidgetAllianceLanguagePanel:createCheckBoxButtons_()
	...
	button = UICheckBoxButton.new(checkbox_image)
            ...
            :setButtonLabelOffset(40, 0)
            :align(display.LEFT_BOTTOM,button:getCascadeBoundingBox().width + 150,start_y)
            :addTo(self)
    button:setTag(11)
   table.insert(self.buttons_,button)
    button = UICheckBoxButton.new(checkbox_image)
    ...
    button = UICheckBoxButton.new(checkbox_image)
            ...
            :setButtonLabelOffset(40, 0)
            :align(display.LEFT_BOTTOM,button:getCascadeBoundingBox().width + 150,start_y + button:getCascadeBoundingBox().height+5)
            :addTo(self)
    button:setTag(8)
    table.insert(self.buttons_,button)
    button = UICheckBoxButton.new(checkbox_image)
            ...
            :setButtonLabelOffset(40, 0)
            :align(display.LEFT_BOTTOM,(button:getCascadeBoundingBox().width + 150)*2,start_y + button:getCascadeBoundingBox().height+5)
            :addTo(self)
    button:setTag(9)
    table.insert(self.buttons_,button)    
    button = UICheckBoxButton.new(checkbox_image)
    ...
    button = UICheckBoxButton.new(checkbox_image)
            ...
            :setButtonLabelOffset(40, 0)
            :align(display.LEFT_BOTTOM,button:getCascadeBoundingBox().width + 150,start_y +(button:getCascadeBoundingBox().height+5)*2)
            :addTo(self)
    button:setTag(5)
    table.insert(self.buttons_,button)
	button = UICheckBoxButton.new(checkbox_image)
            ...
            :setButtonLabelOffset(40, 0)
            :align(display.LEFT_BOTTOM,(button:getCascadeBoundingBox().width+150)*2,start_y +(button:getCascadeBoundingBox().height+5)*2)
            :addTo(self)
    button:setTag(6)
    table.insert(self.buttons_,button)
    button = UICheckBoxButton.new(checkbox_image)
	...
	button = UICheckBoxButton.new(checkbox_image)
            ...
            :setButtonLabelOffset(40, 0)
            :align(display.LEFT_BOTTOM,button:getCascadeBoundingBox().width+150,start_y +(button:getCascadeBoundingBox().height+5)*3)
            :addTo(self)
    button:setTag(2)
    table.insert(self.buttons_,button)
    button = UICheckBoxButton.new(checkbox_image)
            ...
            :setButtonLabelOffset(40, 0)
            :align(display.LEFT_BOTTOM,(button:getCascadeBoundingBox().width+150)*2,start_y +(button:getCascadeBoundingBox().height+5)*3)
            :addTo(self)
    button:setTag(3)
    table.insert(self.buttons_,button)
end
