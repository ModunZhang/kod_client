...
function WidgetAllianceLanguagePanel:createCheckBoxButtons_()
   ...
   table.insert(self.buttons_,button)
    ...
    button = UICheckBoxButton.new(checkbox_image)
            ...
            :setButtonLabelOffset(40, 0)
            :align(display.LEFT_BOTTOM,420,start_y + button:getCascadeBoundingBox().height+5)
            :addTo(self)
    button:setTag(9)
    table.insert(self.buttons_,button)    
    button = UICheckBoxButton.new(checkbox_image)
	...
	button = UICheckBoxButton.new(checkbox_image)
            ...
            :setButtonLabelOffset(40, 0)
            :align(display.LEFT_BOTTOM,420,start_y +(button:getCascadeBoundingBox().height+5)*2)
            :addTo(self)
    button:setTag(6)
    table.insert(self.buttons_,button)
    button = UICheckBoxButton.new(checkbox_image)
    ...
    button = UICheckBoxButton.new(checkbox_image)
            ...
            :setButtonLabelOffset(40, 0)
            :align(display.LEFT_BOTTOM,420,start_y +(button:getCascadeBoundingBox().height+5)*3)
            :addTo(self)
    button:setTag(3)
    table.insert(self.buttons_,button)
end
