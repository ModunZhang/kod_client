...
function WidgetAllianceTop:onEnter()
    ...
    scheduleAt(self, function()
        local res_man = City:GetResourceManager()
        local server_time = app.timer:GetServerTime()
        local wood_number = res_man:GetWoodResource():GetResourceValueByCurrentTime(server_time)
        local food_number = res_man:GetFoodResource():GetResourceValueByCurrentTime(server_time)
        local iron_number = res_man:GetIronResource():GetResourceValueByCurrentTime(server_time)
        local stone_number = res_man:GetStoneResource():GetResourceValueByCurrentTime(server_time)
        local coin_number = res_man:GetCoinResource():GetResourceValueByCurrentTime(server_time)
