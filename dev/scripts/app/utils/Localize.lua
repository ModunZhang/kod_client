...
local BUILDING_DESCRIPTION = {
    ...
    ["wall"] = _("城墙能够有效抵御敌方的进攻，当敌方部队来袭时会自动将城内的部队驻防，升级能够提升城墙的生命值。将龙设置在城墙上驻防还能够持续获得一定的经验值"),
    ["wallHp"] = _("城墙生命值"),
    ["wallRecovery"] = _("城墙恢复"),

    ["tower"] = _("防御塔提供城墙攻击的能力，每解锁一圈地块会增加2座防御塔，升级防御塔等级能提升攻击力。"),
    ["atk"] = _("提供城墙攻击力"),
    ...
    ["dwelling"] = _("住宅能够容纳，每隔一段时间增加一些空闲城民。升级建筑提升城民的最大上限和城民的增长速度"),
