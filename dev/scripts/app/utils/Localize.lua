...
local BUILDING_DESCRIPTION = {
    ...
    ["watchTower_2"] = _("提供来袭部队的龙的类型"),
    ["watchTower_3"] = _("可以查看其他玩家的城市布局"),
    ["watchTower_4"] = _("提供详情按钮，提供：龙的等级和星级"),
    ["watchTower_5"] = _("提供详情按钮，提供：龙的当前生命值和生命值上限，龙的力量"),
    ["watchTower_6"] = _("提供详情按钮，提供：显示兵种的名称，排序"),
    ["watchTower_7"] = _("提供详情按钮，提供：显示兵种的星级"),
    ["watchTower_8"] = _("提供详情按钮，提供：显示兵种的模糊数量"),
    ["watchTower_9"] = _("提供详情按钮，提供：显示龙的装备及其星级"),
    ["watchTower_10"] = _("提供详情按钮，提供：显示龙的技能等级"),
...
local SHRINE_DESC = {
    ...
    ['1_1'] = {_("邪恶苏醒"),_("黑龙带来的灾难还没有结束，一批强盗又在四处作乱，我们需要控制局势")},
    ['1_2'] = {_("寻找线索"),_("这批强盗一定是有备而来，我们必须找到他们的老巢才能一举消灭他们")},
    ['1_3'] = {_("抓活口"),_("我们抓到活口来为我们带路，设下圈套等他们自投罗网")},
    ['1_4'] = {_("搜索边境"),_("被捕的强盗已经招认他们的老巢就在边境附近的一处洞穴，我们必须尽快行动")},
    ['1_5'] = {_("地底深处"),_("这个洞穴居然还通往别处，紧跟着这些恶徒，找出他们的幕后主使")},
    ['1_6'] = {_("背叛者的秘密"),_("原来这一切都是叛军搞的鬼，为了联盟的安定，我们必须粉碎这个阴谋")},

    ['2_1'] = {_("强敌来袭"),_("我们的行动惹怒了叛军的首领，一支叛军的先锋正在赶往这里，做好战斗准备")},
    ['2_2'] = {_("坚守"),_("敌人进攻虽然猛烈，但他们长途奔袭不可能持续进攻，坚守过这波进攻就有希望")},
    ['2_3'] = {_("毫无防备"),_("正面战场敌方无法占到优势，一定会趁乱偷袭，我们得防着他们的小伎俩")},
    ['2_4'] = {_("主动出击"),_("叛军的主力依然疲惫，我们主动出击一定能打他们一个措手不及")},
    ['2_5'] = {_("前后夹击"),_("如果我们能分出一股部队从侧面猛攻敌方，那么击败叛军就是迟早的事")},
    ['2_6'] = {_("暗黑之心"),_("虽然隐隐中不安，但叛军已然溃逃，我们还是尽可能的消弱叛军的力量")},

    ['3_1'] = {_("黑龙军团"),_("叛军的头目尽然已经向黑龙效忠，我们不是他们的对手必须尽快撤离")},
    ['3_2'] = {_("生死搏斗"),_("已经没有别的选择，必须全力一搏，或许才有一线生机")},
    ['3_3'] = {_("逃出生天"),_("穿过这片峡谷并守住谷口，任由敌方有千军万马也无法发挥作用，冲啊")},
    ['3_4'] = {_("地狱之门"),_("我们需要更多援军，这将是一场血腥的厮杀。英勇的领主们，胜败在此一举")},
    ['3_5'] = {_("扭住局势"),_("敌方所有主力都派出了，如果能够击杀这支部队，那么局势将被我们扭转啊")},
    ['3_6'] = {_("贪婪者"),_("我们赢得了暂时的胜利，但黑龙军团留下的战利品却成为了其他领主争夺的目标，我们必须防止事态恶化")},

    ['4_1'] = {_("纷争又起"),_("大战刚刚结束，这些贪婪的领主就不顾联盟之约，公然抢夺战利品，这样的行为必须受到惩罚")},
    ['4_2'] = {_("旧仇恨"),_("原来我们的强大早就遭来其他领主的不满，既然他们不顾联盟之约，我们也无需手下留情")},
    ['4_3'] = {_("抉择"),_("公正终将得到伸张，如果他们放弃那些抢夺的财宝，那么我们就主动出击，给他们点教训")},
    ['4_4'] = {_("大敌当前"),_("这些叛徒知道单打独斗不是我们的对手，竟然联合起来对抗我们。若想要得到联盟的统治权，必须要付出惨痛的代价")},
    ['4_5'] = {_("命运的火与悲"),_("曾经的战友竟然也会倒戈相向，胜者即是正义，拿起手中的武器准备出击")},
    ['4_6'] = {_("混乱之王"),_("混乱的联盟需要新的王者，如果这是命运的安排，那我们只有接受这个挑战")},
}
