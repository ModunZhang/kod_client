...
static int tolua_CCPomelo_connect(lua_State* tolua_S)
{
...
#endif
    {
        ...
        auto stack = CCLuaEngine::defaultEngine()->getLuaStack();
...
#endif
    {
        CCFileUtils* self = CCFileUtils::sharedFileUtils();
        const char* strFolderPath = ((const char*)  tolua_tostring(tolua_S,1,0));
#ifndef TOLUA_RELEASE
...
static int tolua_ext_restart(lua_State* tolua_S)
{
...
#endif
    {
        ...
        CCDirector::sharedDirector()->getScheduler()->scheduleSelector(schedule_selector(AppDelegateExtern::restartGame), &delegateExtern, 0, false,0, false);
    }
    return 0;
#ifndef TOLUA_RELEASE
tolua_lerror:
