    ...
    for i, r in ipairs(map) do
        ...
        for j, c in ipairs(r) do
            ...
            elseif i == 3 and j == 2 then
                table.insert(t, "|")
            elseif i == 2 and j == 51 then
                table.insert(t, "#")
            elseif i == 2 and j == 50 then
                table.insert(t, "—")
            elseif i == 3 and j == 51 then
                table.insert(t, "|")
            elseif i == 51 and j == 2 then
                table.insert(t, "#")
            elseif i == 51 and j == 3 then
                table.insert(t, "—")
            elseif i == 50 and j == 2 then
                table.insert(t, "|")
            elseif i == 51 and j == 51 then
                table.insert(t, "#")
            elseif i == 51 and j == 50 then
                table.insert(t, "—")
            elseif i == 50 and j == 51 then
                table.insert(t, "|")
            else
