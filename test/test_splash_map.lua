...
function test_alliance_map()
    ...
    -- --联盟建筑
    --  while #rects < r_3_1 + r_3_2 do
    --     local index = math.floor(math.random() * 100000) % #random_map + 1
    --     local rect = random_rect_by_index(random_map[index], 1, map)
    --     if rect then
    --         rect["type"] = 2
    --         table.insert(rects, rect)
    --         mark_map_with_rect(map, rect,2)
    --     end
    --     table.remove(random_map, index)
    -- end
    ...
    -- while #rects < r_3_1 + r_3_2 + r_3_3 do
    --     local index = math.floor(math.random() * 100000) % #random_map + 1
    --     local rect = random_rect_by_index(random_map[index], 1, map)
    --     if rect then
    --         rect["type"] = 3
    ...
    -- while #rects < r_3_1 + r_3_2 + r_2_1 + r_3_3 do
    --     local index = math.floor(math.random() * 100000) % #random_map + 1
    ...
    -- while #rects < r_3_1 + r_3_2 + r_2_1 + r_2_2 + r_3_3 do
    --     local index = math.floor(math.random() * 100000) % #random_map + 1
    --     local rect = random_rect_by_index(random_map[index], 2, map)
    --     if rect then
    --         rect['type'] = 5
    ...
    print("城市------>",r_1_1)
     randomRect(map,rects,random_map,3,6,r_1_1)
    -- while #rects < r_3_1 + r_3_2 + r_2_1 + r_2_2 + r_1_1 + r_3_3 do
    --     local index = math.floor(math.random() * 100000) % #random_map + 1
    --     local rect = random_rect_by_index(random_map[index], 3, map)
    --     if rect then
    --         rect['type'] = 6
    --         table.insert(rects, rect)
    --         mark_map_with_rect(map, rect,6)
    --     end
    --     table.remove(random_map, index)
    -- end

    print("树------>",20)
    randomRect(map,rects,random_map,3,7,20)
    -- while #rects < 20 + r_3_1 + r_3_2 + r_2_1 + r_2_2 + r_1_1 + r_3_3 do
    --     local index = math.floor(math.random() * 100000) % #random_map + 1
    --     local rect = random_rect_by_index(random_map[index], 3, map)
    --     if rect then
    --         rect['type'] = 7
    --         table.insert(rects, rect)
    --         mark_map_with_rect(map, rect,7)
    --     end
    --     table.remove(random_map, index)
    -- end
    out_put_map(map)
